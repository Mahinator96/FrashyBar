const API_URL = "https://deciduous-warm-gauge.glitch.me/";
...
const createCartItem = (item) => {
	...
	li.innerHTML = 
		`
			<img class="order__img" src="img/cup-1.jpg" width="70" height="82" alt="${item.title}">
...
const renderCart = () => {
	...
	const orderTotalPrice = modalOrder.querySelector('.order__price-total');
